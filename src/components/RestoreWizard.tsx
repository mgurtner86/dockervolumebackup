    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <div>
            <h2 className="text-2xl font-semibold text-slate-800">Restore Wizard</h2>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium text-slate-800 mb-2">Full Restore</h4>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center gap-2 text-sm text-slate-700 bg-slate-100 rounded px-3 py-2">
                      <HardDrive size={16} />
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium text-slate-800 mb-2">Custom Path</h4>
